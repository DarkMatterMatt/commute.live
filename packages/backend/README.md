...
| :---------------------------- | :-------------------------------------------------------------------------------------------------------------- | :-------- | :------------ |
| `AUCKLAND_TRANSPORT_KEY_DVS`  | API key for the [Auckland Transport Developer Portal](https://dev-portal.at.govt.nz/) ("Developers").           | string    | ⭐            |
| `AUCKLAND_TRANSPORT_KEY_PTD`  | API key for the [Auckland Transport Developer Portal](https://dev-portal.at.govt.nz/) ("Public Transport Dev"). | string    | ⭐            |
